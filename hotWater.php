...
<html lang="en">
  ...
  <header class="navbar">
    ...
    <div class="service-card">
      <div class="row card-wrapper">
        ...
        <div class="column right-side">
          <h2>HOT WATER SYSTEMS<br /><span class="font-m color-blue">IN MELBOURNE</span></h2>
          <p>
          When it comes to replacing your current hot water heater, it's understandable that you'd be interested. Gas hot water systems  are currently the most effective and dependable options available today, both in terms of efficiency and dependability.
          <br><br> The advantages of a gas-powered hot water heater over an electric one are numerous. You can save money and help the environment by using it. Tank storage and instant heating are both options for gas hot water system’ installation; while electric heaters only provide the option of tank storage.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="column what-to-do">
      <h2><span class="color-blue">ADVANTAGES OF </span>HOT WATER SYSTEMS</h2>
      <p>
        Many gas hot water systems have their own advantages and disadvantages, making it difficult to choose the right one. Some of the things you'll need to keep in mind are:
        <br><br>Choosing the right hot water system for your home is one of the most important decisions you'll ever make. At PlumbFirst, we deal with a variety of hot water systems and are familiar with the advantages and disadvantages of each. Our customers’ reviews are a great way to learn why so many people have come to rely on us. 
      </p>
      <div class="row timeline">
        <div class="container">
          <div class="content">
            <p>Your household's daily water consumption.</p>
          </div>
        </div>
        <div class="container">
          <div class="content">
            <p>If you have a problem with a lack of room in your house.</p>
          </div>
        </div>
        <div class="container">
          <div class="content">
            <p>Your gas hot water system’s price range.</p>
          </div>
        </div>
        <div class="container">
          <div class="content">
            <p>Any preference for a particular brand.</p>
          </div>
        </div>
        <div class="container">
          <div class="content">
            <p>Whether you want to store hot water in a tank or have it available all the time</p>
          </div>
        </div>
        <div class="container">
          <div class="content">
            <p>Energy-saving concern</p>
          </div>
        </div>
      </div>
