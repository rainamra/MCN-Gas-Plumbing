...
<html lang="en">
  ...
  <header class="navbar">
    ...
    <div class="service-banner">
      <div class="row banner-container">
        <div class="column left-side">
          <h1>OUTDOOR BBQ INSTALLATION</h1>
          <ul class="row">
            <li>
    ...
    <div class="service-card">
      <div class="row card-wrapper">
        ...
        <div class="column right-side">
          <h2>OUTDOOR BBQ INSTALLATION<br /><span class="font-m color-blue">IN MELBOURNE</span></h2>
          <p>
          Sydney residents are increasingly turning to gas as a source of energy. A growing number of households are making the switch from electric to gas because of the lower costs and less impact on the environment that gas has.
          <br><br>Trusting an experienced gas fitter with the installation of your new gas BBQ is the best option if you're looking to have one installed in your home. A gas outdoor BBQ installation process would be seamless if it were handled by an expert in the field.
          <br><br>A skilled gas fitter can handle everything from the installation of new gas lines to the expansion of existing lines. Installing a gas barbecue outside? If so, you'll want to hire the best plumbers you can find.
          <br><br>PlumbFirst Sydney is here to help you get the job done right the first time.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="column what-to-do">
      <h2><span class="color-blue">WHO SHOULD PERFORM </span>GAS FITTING OF BBQ</h2>
      <p>
      ...
      <br><br>When a gas BBQ is installed incorrectly, it can result in a wide range of issues. A new gas BBQ appliance or reinstalling the old one is usually required to fix the problem. As a result of improper installation, gas leaks may occur. In addition to having an impact on food quality, a gas leak could pose a serious health risk. Your outdoor party has come to an abrupt end because you must immediately shut down your BBQ time.
      <br><br>To avoid a gas leak, you should contact an expert gas installation service that will ensure that your gas BBQ is installed correctly the first time around. Your gas piping will be checked for leaks, and they'll also make absolutely sure that everything is connected properly.
      <br><br>As a result, you should only trust PlumbFirst, a professional gas plumbing company, with the job. In order to ensure an entire risk-free procedure, our licensed professionals have thoroughly inspected all of your essential appliances.
      </p>
